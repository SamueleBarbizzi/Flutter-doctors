...
class RecipePage extends StatelessWidget {
  const RecipePage({Key? key, required this.recipe, required this.dish}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: BackButton(
            onPressed: (){_toCookBookPage(context);}
          ),
        ...
        child: Container( padding: const EdgeInsets.all(5),
          child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    Padding( padding: const EdgeInsets.fromLTRB(0,0,10,0),
                      child: Container( //color: Colors.brown,
                        child: Column( mainAxisAlignment: MainAxisAlignment.end, 
                          children: [ 
                            const Icon(MdiIcons.fire, color: Colors.orange, size: 30),
                            Row( children: [ 
            ...
            /* Container( height: 300, //width: 400,
              ...
              const SizedBox(height:15),
              Container( width: 450, padding: const EdgeInsets.fromLTRB(10,5,5,5), //margin: EdgeInsets.fromLTRB(10, 0, 10, 0),
                decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border.all(color: Colors.grey.shade400, width: 1.0),
                    borderRadius: BorderRadius.circular(10),
                ...
                child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Ingredients:", textAlign: TextAlign.left,
                      style: TextStyle(
                      //height: 10,
                      fontWeight: FontWeight.bold,
                      fontSize: 28,
              ...
              const SizedBox(height:15),
              Container( padding:const EdgeInsets.fromLTRB(10,5,5,5),
                decoration: BoxDecoration(
                    color: Colors.white,
                    border: Border.all(color: Colors.grey.shade400, width: 1.0),
                    borderRadius: BorderRadius.circular(10),
